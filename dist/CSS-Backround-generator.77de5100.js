...
var directionSel = document.getElementById("directionSel");
var colorSel = document.getElementById("colorSel");
var color3;
var colorSwCounter = 0; // making default CSS lines appear
...
setDefaultCSS(); // adding a 3rd color option
...
function add3color() {
  if (colorSel.value === "3" && colorSwCounter === 0) {
    ...
    input3.setAttribute("value", "#0000ff"); //input3.setAttribute("class", "animated fadeInRight delay-0.2s");
...
function remove3Color() {
  colorBox.removeChild(color3);
  body.style.background = directionSel.value + color1.value + ", " + color2.value + ")";
  colorSwCounter--;
...
function setGradient() {
  if (color3 === undefined) {
    ...
    body.style.background = directionSel.value + color1.value + ", " + color2.value + ", " + color3.value + ")";
  }
...
//# sourceMappingURL=/CSS-Backround-generator.77de5100.map